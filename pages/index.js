...
const MathAfriqueThroughTime = () => {
  ...
  const styles = `
    ...
    .african-pattern-sidebar {
      background-image: url("data:image/svg+xml,%3Csvg width='20' height='20' viewBox='0 0 20 20' xmlns='http://www.w3.org/2000/svg'%3E%3Cg fill='%23b45309' fill-opacity='0.1' fill-rule='evenodd'%3E%3Ccircle cx='3' cy='3' r='3'/%3E%3Ccircle cx='13' cy='13' r='3'/%3E%3C/g%3E%3C/svg%3E");
    }
    
    .african-border {
      border-image: repeating-linear-gradient(45deg, #92400e, #92400e 10px, #b45309 10px, #b45309 20px) 1;
      border-width: 4px;
    ...
    .mud-cloth-pattern {
      ...
      background-image: url("data:image/svg+xml,%3Csvg width='40' height='40' viewBox='0 0 40 40' xmlns='http://www.w3.org/2000/svg'%3E%3Cg fill='%236366f1' fill-opacity='0.1' fill-rule='evenodd'%3E%3Cpath d='M0 0h40v40H0V0zm40 40h40v40H40V40zm-40 0h40v40H0V40z'/%3E%3C/g%3E%3C/svg%3E");
    }
  `;
